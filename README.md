...
* **/status** — сводка и список текущих проблем
...
Показывает количество открытых проблем по степеням серьёзности и список последних проблем с их хостами и временем.
